...
def grade_func(file,step=0,outp=sys.stdout):
    """
    Returns the test result and score for the implementation of is_before
    ...
    testcases = [(d1,d2,True),(d2,d1,False),(d3,d4,True),(d4,d3,False),
                 (d1,d3,True),(d3,d1,False),(d3,d3,False),(d3,d3,False)]
