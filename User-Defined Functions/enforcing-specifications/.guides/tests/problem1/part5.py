...
if len(answer) == 0:
    ...
    result = False
elif 'File "funcs.py", line 71, in' in answer[1]:
    print('Make sure you commented out the assignment to y.')
    result = False
elif not 'File "funcs.py", line 72, in' in answer[1]:
    print("Make sure the assignment to variable z is still at line 72.")
    result = False
