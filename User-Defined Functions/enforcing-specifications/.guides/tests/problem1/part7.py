...
if len(answer) == 0:
    ...
    result = False
elif 'File "funcs.py", line 72, in' in answer[1]:
    print('Make sure you commented out the assignment to z.')
    result = False
elif not 'File "funcs.py", line 73, in' in answer[1]:
    print("Make sure the assignment to variable w is still at line 73.")
    result = False
