...
def grade_func1(file,step=0,outp=sys.stdout):
    ...
    tup2 = (1,2,3,4)
    tup3 = (2,)
    testcase = [(tup1,5,2),(tup1,4,1),(tup1,3,0),(tup1,2,0),(tup1,6,4),(tup1,10,6),
                (tup1,20,7),(tup2,1,0),(tup2,2,1),(tup2,3,2),(tup2,4,3),(tup2,5,4),
                (tup3,2,0),(tup3,3,1)]
...
def grade_func2(file,step=0,outp=sys.stdout):
    ...
    function = 'avg'
    testcase = [( (7, 1, 4, 3, 6, 8) , 4.833333333333333 ),
                ( (-1, 1, 3, 5), 2.0 ),
                ( (2.5,), 2.5 ),
                ( (1.0, 1.0, 1.0), 1.0 ),
                ( (), 0.0 ),
