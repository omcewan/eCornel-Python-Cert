...
def grade_func(file,step=0,outp=sys.stdout):
    """
    Returns the test result and score for the implementation of bjack
    ...
    function = 'bjack'
    testcase = [((),0),(('2H',),2),(('3D',),3),(('4C',),4),(('5S',),5),(('6H',),6),
                (('7D',),7),(('8C',),8),(('9S',),9),(('TH',),10),(('JD',),10),(('QC',),10),
                (('KS',),10),(('AH',),11),((),0),(('6H','9C'),15),(('2C','TH'),12),
                (('3H','5C', '7D', '9S'),24),(('TS','JD'),20),
                (('KS','AD'),21),(('KS','9C','AD'),20),
                (('JS','QC','AH'),21),(('AS','AC','KH'),12),
                (('AS','AC','KH','TD'),22),
                (('4H','AS','AD','TC','AH','AC', '2S'),20)]
