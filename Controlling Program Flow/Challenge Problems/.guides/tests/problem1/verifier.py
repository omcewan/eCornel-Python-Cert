...
def grade_func(file,step=0,outp=sys.stdout):
    """
    Returns the test result and score for the implementation of findall
    ...
    function = 'findall'
    testcase = [('how now brown cow','ow',(1, 5, 10, 15)),
                ('how now brown cow','brown',(8,)),
                ('how now brown cow','cat',()),
                ('the cat in the hat had a sad','a',(5, 16, 20, 23, 26)),
                ('jeeepeeer','ee',(1, 2, 5, 6)),
                ('the quick brown fox jumps over the lazy dog','o',(12, 17, 26, 41)),
                ('the quick brown fox jumps over the lazy dog','the',(0, 31)),
                ('the quick brown fox jumps over the lazy dog','u',(5, 21)),
                ('','a',())]
