...
def grade_func(file,step=0,outp=sys.stdout):
    """
    Returns the test result and score for the implementation of encode
    ...
    function = 'encode'
    testcase = [('attackatdawn',3,'dwwdfndwgdzq'),
                ('dwwdfndwgdzq',23,'attackatdawn'),
                ('attackatdawn',13,'nggnpxngqnja'),
                ('nggnpxngqnja',13,'attackatdawn'),
                ('ordertheretreat',13,'beqregurergerng'),
                ('beqregurergerng',13,'ordertheretreat'),
                ('letsmeetforlunch',10,'vodcwoodpybvexmr'),
                ('vodcwoodpybvexmr',16,'letsmeetforlunch'),
                ('ijustwanttosayhi',0,'ijustwanttosayhi'),
                ('ijustwanttosayhi',1,'jkvtuxbouuptbzij'),
                ('',25,'')] 
